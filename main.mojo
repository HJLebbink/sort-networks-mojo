...
fn main():
    ...
    if False:
        ...
        alias sd2 = sort_tools.linear_add(
            sort_tools.layers_to_linear(swap_data[56]()), 8
        )
        materialize[sort_tools.linear_print(sd1)]()
        materialize[sort_tools.linear_print(sd2)]()
    ...
    if False:  # runtime crash
        ...
        print(String(sd1))
        alias sd2: SwapData = batcher_odd_even_merging.batcher_odd_even_merge_network[
            channels
        ]()
        print(String(sd2))
